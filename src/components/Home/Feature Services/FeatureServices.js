...
const FeatureServices = () => {
  return (
    <div>
      <div className="grid grid-rows-3 grid-flow-col gap-4 my-12 mx-8">
        <div className="row-span-3 col-span-2 bg-yellow-300 ...">
          <img
        ...
        <div className="row-span-2 bg-yellow-300 col-span-2  rounded...">
          <img
        ...
        <div className=" bg-yellow-300 col-span-1  rounded...">
          <img
            className="rounded"
